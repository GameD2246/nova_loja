...
<div class="row">
    <div class="col-sm-6 ">
        <h3><?php $this->lang->get('PRODUCT_SPECIFICATIONS'); ?> <hr></h3>
        <p><?php echo utf8_encode($product_info['description']); ?> <hr></p>
        <?php foreach ($product_options as $po): ?>
            <div>
                <div class="col-sm-6 product_specifications">
                    <strong><?php echo $po['name']; ?></strong>
                </div>

                <div class="col-sm-6 product_specifications_result"> 
                    <?php echo $po['value']; ?>
                </div>
                <hr>
            </div>
    ...
    <div class="col-sm-6">
        <h3><?php $this->lang->get('PRODUCT_REVIEWS'); ?> <hr></h3>
